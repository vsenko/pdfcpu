...
[![GoDoc](https://godoc.org/github.com/vsenko/pdfcpu?status.svg)](https://pkg.go.dev/github.com/vsenko/pdfcpu)
[![Go Report Card](https://goreportcard.com/badge/github.com/vsenko/pdfcpu)](https://goreportcard.com/report/github.com/vsenko/pdfcpu)
...
* [API tests](https://github.com/vsenko/pdfcpu/tree/master/pkg/api/test)
* [API samples](https://github.com/vsenko/pdfcpu/tree/master/pkg/samples) 
* CLI usage: `$ pdfcpu help cmd`

### GoDoc

* [pdfcpu package](https://pkg.go.dev/github.com/vsenko/pdfcpu)
...
```
$ git clone https://github.com/vsenko/pdfcpu
...
```
$ go install github.com/vsenko/pdfcpu/cmd/pdfcpu@latest
```
